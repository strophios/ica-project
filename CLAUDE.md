...
*Last updated: 2026-05-08 (Tier 3 Piece 2: Pattern 2 serialization round-trip + shape-mismatch tests; `skip_mismatch=False` discipline in production load_weights calls; empirical finding that Keras `.weights.h5` matching is structural, not name-based).*
